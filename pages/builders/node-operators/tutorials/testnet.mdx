...
Find and navigate to the directory where you built the `op-node` binary. Usually found in `op-node`.
...
For more information on the beacon URL consult ../../notices/ecotone-changes.mdx
